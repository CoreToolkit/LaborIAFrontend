...
export const LoginForm = () => {
  ...
  const handleMicrosoftLogin = () => {
    // Implementación futura de Microsoft OAuth
    router.push('/dashboard');
  };
  ...
  return (
    <div className="w-full max-w-md space-y-6 ">
      ...
      <div className="p-8 border-2 border-gray-200 rounded-xl bg-white shadow-sm space-y-6">
        ...
        <Button type="submit" className="w-full border-1 cursor-pointer hover:bg-blue-600 hover:text-white transition-colors" size="lg">
          Iniciar sesión
        </Button>
      </form>
